    ...
    try {
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            // Verify payment
            const verifyResponse = await axios.post(`http://localhost:3000/payments/verify-payment`, {
            ...
            if (verifyResponse.data.success) {
              ...
              const createOrderResponse = await axios.post(`http://localhost:3000/orders`, orderData)
