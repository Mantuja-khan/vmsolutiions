...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    try {
      ...
      const orderResponse = await axios.post(`${import.meta.env.VITE_API_URL}/payments/create-order`, {
        amount: totalAmount
      })
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            // Verify payment
            const verifyResponse = await axios.post(`${import.meta.env.VITE_API_URL}/payments/verify-payment`, {
            ...
            if (verifyResponse.data.success) {
              ...
              const createOrderResponse = await axios.post(`${import.meta.env.VITE_API_URL}/orders`, orderData)
